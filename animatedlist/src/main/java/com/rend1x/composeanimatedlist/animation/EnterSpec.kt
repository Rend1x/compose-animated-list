...
sealed interface EnterSpec {
    ...
    data class Fade(val durationMillis: Int = 220) : EnterSpec

    data class SlideVertical(val offset: Dp = 16.dp, val durationMillis: Int = 220) : EnterSpec

    data class FadeAndSlide(val offset: Dp = 16.dp, val durationMillis: Int = 240) : EnterSpec
}
